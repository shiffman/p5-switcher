...
function draw() {
  ...
  for (let x = 0; x < width; x += 20) {
    ...
    let y= r * sin(angle + offset) * 2;
    strokeWeight(2);
    // line(x *1.4, y - 300, x/1.1 , y - 600);
    // line(x, y -100 ,x *1.4, y - 300 );
     line(x, y + 206,x , y + 256 );
    arc(x, y - 200+x/2 , r + 20, r, 0, PI);
    arc(x, y -250+x/2, r + 20, r,  PI,2*PI);
    
   
    line(x , y - 250,x*1.1 , y - 420);
   
    arc(x * 1.8, y + 90 + x, r - 20, r - 30, PI, 2 * PI);
    arc(x * 1.8, y + 90 + x, r - 20, r - 30, 0, PI);
    offset += 0.4;
  }
  angle += 0.04;
  // r+=random(-2,2)
